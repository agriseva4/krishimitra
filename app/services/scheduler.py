    ...
    try:
        ...
        for f in farmers:
            try:
                ...
                if not mapped:
                    # टीप: आधी इथे "Onion","Tomato" असा silent default होता — farmer ने
                    # कधीच पीक सांगितलं नसलं तरी रोज त्याला onion/tomato भाव पाठवला जायचा,
                    # जो त्याच्याशी काहीच संबंधित नसू शकतो. आता असा farmer या रोजच्या
                    # broadcast मधून वगळला जातो — भलतंच काहीतरी पाठवण्यापेक्षा काहीच न
                    # पाठवणं बरं.
                    log.info(f"Daily mandi skip (no crops set): {f.get('phone')}")
                    continue
